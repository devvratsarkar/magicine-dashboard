...
import { useEditCarrierMutation, useGetAllCarrierQuery } from "../redux/features/shippingZoneEndPoints";
...
export const CarrierDatas = () => {
  ...
  const { data, isError, error, isLoading, isFetching } = useGetAllCarrierQuery();
  ...
  const showAddTrash = role === "Admin" || (role === "Staff" && permissions.Carrier.includes("add-trash"))
      ...
      cell: (row) => (
        <div className="action_icon_wrapper">
          <OverlayTrigger placement="top" overlay={<Tooltip>View</Tooltip>}>
            <Link to={`/shipping/carrier/view-carrier/${row?.id}`}> <Button className="btn btn-icon btn-primary"> <i className="fe fe-eye"></i> </Button> </Link>
          </OverlayTrigger>
          {
            showEdit && (
              <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
                <Link to={`/shipping/carrier/edit-carrier/${row?.id}`}> <Button className="btn btn-icon btn-warning" variant=""> <i className="fe fe-edit"></i> </Button> </Link>
              </OverlayTrigger>
            )
          }
          {
            showAddTrash && (
              <OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
                <Button className="btn btn-con btn-danger border-danger" onClick={() => { dispatch(openModal({ componentName: 'DeleteCarrier', data: row, softDelete: true })) }}> <i className="fe fe-trash"></i> </Button>
              </OverlayTrigger>
            )
          }
        </div>
