...
import ProductWithoutVariant from '../../inventory-without-variant/ProductWithoutVariant';
import { ProductInventoryWithVariant } from '../../../commondata/ProductInventoryWithVariant';

export default function GeneralProductInventory() {
    ...
    return (
        <>
            <Row className='align-items-center'>
                <Col>
                    <PageHeader titles="Inventory" active="General Product Inventory" items={['Home']} links={["/dashboard"]} />
                </Col>
