...
import { useEditMedicineMutation, useGetMedicineInventoryQuery, useGetSingleMedicinesQuery } from '../../redux/features/productEndPoints';
...
export default function ViewReVieMedicine() {
    const { id } = useParams()
    ...
    if (isSuccess) {
        return (
            <>
                <Row>
                    <Col>
                        <PageHeader titles="Review Medicine" active={["View Reviewing Medicine"]} items={["Home", "Medicine List"]} links={["/dashboard", "/catalogue/medicines"]} />
                    </Col>
                </Row>
                <Row>
                    <Col>
