...
import { CMSRefundReturnPolicyValidation } from "../../../commondata/formvalidations";
import { options_for_sunEditor } from "../../../commondata/formEditorOptions";
import Suneditor from "suneditor-react";
import "suneditor/dist/css/suneditor.min.css";
import SeoForm from "../../seo-page/SeoForm"
import { useAddCustomerSupportPolicyMutation, useAddRefundReturnPolicyMutation, useGetCustomerSupportrPolicyQuery, useGetRefundReturnPolicyQuery } from "../../../redux/features/cmsEndPoints"
import toast from "react-hot-toast";
import Loader from "../../../layouts/layoutcomponents/loader";
import { MEDIA_BASE_URL, USER_BASE_URL } from "../../../utils/config";

export default function CMSRefunReturnPolicy() {
  const [selectedThubnail, setSelectedThubnail] = useState(null);
  const [viewThubnail, setViewThubnail] = useState(true);
  const { data, isError, error, isLoading, isFetching, isSuccess, refetch } = useGetRefundReturnPolicyQuery()
  const [addcustomerSupport, { isLoading: loading }] = useAddRefundReturnPolicyMutation()

  const role = localStorage.getItem("role")
  const permissions = JSON.parse(localStorage.getItem("permissions"))


  const showButton = role === "Admin" || (role === "Staff" || permissions.Refund_return.includes("add"))
  ...
  const {
    ...
    validationSchema: CMSRefundReturnPolicyValidation,
