    ...
    <div>
      ...
      <Row>
        ...
        <Col md={12} lg={8} xl={9}>
          <Card>
            <Card.Header>
              <h3 className="card-title text-muted">Drafts</h3>
            </Card.Header>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td>
                              <ActionOption
                                id={row.original.ID}
                                mail={row.original.CUSTOMER_MAIL_ID}
                              />
                            </td>
                          </tr>
                        );
