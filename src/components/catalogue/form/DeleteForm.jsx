...
import { useAddTrashFormMutation, useDeleteTrashFormMutation, useGetAllFormQuery, useGetAllTrashFormQuery } from "../../../redux/features/catalogueEndPoints";
...
export default function DeleteForm() {
    ...
    const { refetch: trashFetched } = useGetAllTrashFormQuery();
    const { isOpen, data, softDelete } = useSelector((state) => state.allCommonModal);
    const [addTrashUses, { isLoading }] = useAddTrashFormMutation();
    const [deleteTrashUses, { isLoading: loading }] = useDeleteTrashFormMutation();
