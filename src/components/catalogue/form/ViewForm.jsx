...
import { useAddUsesMutation, useGetSingleFormQuery, useGetSingleUsesQuery } from '../../../redux/features/catalogueEndPoints';
...
export default function ViewForm() {
    ...
    const { data: usesData, isLoading: loading, isSuccess: success } = useGetSingleFormQuery(data?.id)
    const initialValues = {
        name: ""
    };
