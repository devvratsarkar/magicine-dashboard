...
import { useAddFormMutation, useAddUsesMutation, useGetAllFormQuery, useGetAllUsesQuery } from '../../../redux/features/catalogueEndPoints';
...
export default function AddForm() {
    ...
    const [addUses, { isLoading }] = useAddFormMutation();
