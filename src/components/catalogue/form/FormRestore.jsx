...
import { useGetAllFormQuery, useGetAllTrashFormQuery, useRestoreTrashFormMutation } from "../../../redux/features/catalogueEndPoints";
import { closeModal } from "../../../redux/slices/allModalSlice";
import Loader from "../../../layouts/layoutcomponents/loader";

export default function FormRestore() {
    const { isOpen, data, } = useSelector((state) => state.allCommonModal);
    const [brandRestore, { isLoading }] = useRestoreTrashFormMutation()
    const { refetch } = useGetAllFormQuery();
    const { refetch: refchDeleted } = useGetAllTrashFormQuery();
