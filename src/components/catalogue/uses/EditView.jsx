...
import { useEditUsesMutation, useGetAllUsesQuery, useGetSingleUsesQuery } from '../../../redux/features/catalogueEndPoints';
...
export default function EditUses() {
    ...
    const [editUses, { isLoading }] = useEditUsesMutation();
    const { data: usesData, isLoading: loading, isSuccess: success, refetch: singleFetch } = useGetSingleUsesQuery(data?.id)
