...
import { useDeleteReviewMutation, useGetReviewsDataQuery, useGetSelectedReviewsQuery, useReviewStatusFalseMutation } from '../../redux/features/catalogueEndPoints'
...
function DeleteReview() {
    ...
    const [reviewStatusFalse, { isLoading }] = useDeleteReviewMutation()
    ...
    return (
        <>
            ...
            <Modal show={isOpen}>
                ...
                <Modal.Body>
                    <p className='text-center'>Are you sure you want to delete this review?</p>
                </Modal.Body>
